...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="TahunGURU.css">
...
<body>
  ...
  <script>
    document.getElementById('profile-picture').addEventListener(
      ...
      {
        window.location.href = 'Tahun/TahunGURU/2024GURU.php';
      }
      );
...
{
  window.location.href = 'Tahun/TahunGURU/2023GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2022GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2021GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2020GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2019GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2018GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2017GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2016GURU.php';
}
);
...
{
  window.location.href = 'Tahun/TahunGURU/2015GURU.php';
}
);
  </script>
</html>