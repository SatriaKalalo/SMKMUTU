...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="TahunTMI.css">
...
{
  window.location.href = 'Tahun/TahunTMI/2024TMI.php';
}
);
...
{
window.location.href = 'Tahun/TahunTMI/2023TMI.php';
}
);
...
{
window.location.href = 'Tahun/TahunTMI/2022TMI.php';
}
);
...
{
window.location.href = 'Tahun/TahunTMI/2021TMI.php';
}
);
...
{
window.location.href = 'Tahun/TahunTMI/2020TMI.php';
}
);
...
{
window.location.href = 'Tahun/TahunTMI/2019TMI.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTMI/2018TMI.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTMI/2017TMI.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTMI/2016TMI.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTMI/2015TMI.php';
}
);
  </script>
</html>