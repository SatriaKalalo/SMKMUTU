...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="TahunTKJ.css">
...
<body>
  ...
  <script>
    document.getElementById('profile-picture').addEventListener(
      ...
      {
        window.location.href = 'Tahun/TahunTKJ/2024TKJ.php';
      }
      );
...
{
  window.location.href = 'Tahun/TahunTKJ/2023TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2022TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2021TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2020TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2019TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2018TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2017TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2016TKJ.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKJ/2015TKJ.php';
}
);
  </script>
</html>