...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="TahunTKR.css">
...
<body>
  ...
  <script>
    document.getElementById('profile-picture').addEventListener(
      ...
      {
        window.location.href = 'Tahun/TahunTKR/2024TKR.php';
      }
      );
...
{
  window.location.href = 'Tahun/TahunTKR/2023TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2022TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2021TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2020TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2019TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2018TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2017TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2016TKR.php';
}
);
...
{
  window.location.href = 'Tahun/TahunTKR/2015TKR.php';
}
);
  </script>
</html>